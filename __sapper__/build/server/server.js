...
const css = {
	code: "h1.svelte-96bxhk{text-align:center;margin:0 auto}h1.svelte-96bxhk{font-size:2.8em;text-transform:uppercase;font-weight:700;margin:0 0 0.5em 0}button.svelte-96bxhk{position:relative;top:50%;left:25%;width:50%;color:darkred}@media(min-width: 480px){h1.svelte-96bxhk{font-size:4em}}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<style>\\n\\th1, figure, p {\\n\\t\\ttext-align: center;\\n\\t\\tmargin: 0 auto;\\n\\t}\\n\\n\\th1 {\\n\\t\\tfont-size: 2.8em;\\n\\t\\ttext-transform: uppercase;\\n\\t\\tfont-weight: 700;\\n\\t\\tmargin: 0 0 0.5em 0;\\n\\t}\\n\\n\\tbutton {\\n\\t\\tposition: relative;\\n\\t\\ttop: 50%;\\n\\t\\tleft: 25%;\\n\\t\\twidth: 50%;\\n\\t\\tcolor: darkred;\\n\\t}\\n\\n\\tp {\\n\\t\\tmargin: 1em auto;\\n\\t}\\n\\n\\t@media (min-width: 480px) {\\n\\t\\th1 {\\n\\t\\t\\tfont-size: 4em;\\n\\t\\t}\\n\\t}\\n</style>\\n\\n<script>\\n\\tfunction handleCreateClick() {\\n\\t\\tlocation.href='about'\\n\\t}\\n\\n\\tfunction handleJoinClick() {\\n\\t\\talert('no more alerts')\\n\\t}\\n</script>\\n\\n<svelte:head>\\n\\t<title>Sapper project template</title>\\n</svelte:head>\\n\\n<h1>Welcome to House of Cards!</h1>\\n\\n<button id=\\\"createButton\\\" on:click={handleCreateClick}>\\n\\tCreate Room\\n</button>\\n\\n<button id=\\\"joinButton\\\" on:click={handleJoinClick}>\\n\\tJoin Game\\n</button>\\n\"],\"names\":[],\"mappings\":\"AACC,EAAE,cAAY,CAAC,AACd,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,CAAC,CAAC,IAAI,AACf,CAAC,AAED,EAAE,cAAC,CAAC,AACH,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AACpB,CAAC,AAED,MAAM,cAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,GAAG,CACT,KAAK,CAAE,GAAG,CACV,KAAK,CAAE,OAAO,AACf,CAAC,AAMD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,EAAE,cAAC,CAAC,AACH,SAAS,CAAE,GAAG,AACf,CAAC,AACF,CAAC\"}"
};
...
<h1 class="${"svelte-96bxhk"}">Welcome to House of Cards!</h1>

<button id="${"createButton"}" class="${"svelte-96bxhk"}">
	Create Room
</button>

<button id="${"joinButton"}" class="${"svelte-96bxhk"}">
	Join Game
</button>`;
});
